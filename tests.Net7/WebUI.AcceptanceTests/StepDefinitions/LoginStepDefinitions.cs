using RapidBlazor.Old.WebUI.AcceptanceTests.Pages;

namespace RapidBlazor.Old.WebUI.AcceptanceTests.StepDefinitions;
...
public sealed class LoginStepDefinitions
{
    ...
    public async Task TheyLogInSuccessfully()
    {
        ...
        profileLinkText.Should().Be("Hello, admin@localhost!");
    }
